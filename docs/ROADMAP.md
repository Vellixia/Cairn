...
- [ ] **Historical record cleanup:** Feature 004's archived [200 task boxes](https://github.com/Vellixia/Cairn/blob/v0.1.0-alpha.7/specs/004-collaborative-global-memory/tasks.md) are unchecked despite alpha.7 shipment. Reconcile only if maintaining that archive; do not infer alpha.8 functionality from its task count. Alpha.8 tagged tree removed `specs/` entirely.
