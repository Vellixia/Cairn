...
- **Screenshots:**
  - `docs/live-e2e/screenshots/07-tier-promotion/graph.png` (force-directed graph, NODES=16, EDGES=6, CRYSTALS=6)
  - `docs/live-e2e/screenshots/07-tier-promotion/wakeup.png` (wakeup list, top card is the gotcha with kind=gotcha, importance=0.80)
