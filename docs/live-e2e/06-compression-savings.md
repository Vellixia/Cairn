...
- **Screenshots:**
  - `docs/live-e2e/screenshots/06-compression-savings/savings.png` (KPI strip + 7-row ledger)
  - `docs/live-e2e/screenshots/06-compression-savings/live-update.png` (same page, 8 rows after a context.read)
