//! `cairn pair` — claim a pairing code generated by a Cairn server.
//!
//! The host mints a short-lived, single-use code (from the dashboard **You → Pair** page).
//! A new device claims it over the network to receive its device token.
