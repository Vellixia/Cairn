...
Cairn is durable, project-scoped memory for this repository. It is shared by every agent
working on the project, so what one session learns the next one already knows.
