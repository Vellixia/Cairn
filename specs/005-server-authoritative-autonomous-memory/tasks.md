...
- [X] T015 Extend the one canonical topic/value-key normalizer with approved separator folding while preserving dot-segment semantics and rejecting—not repairing—invalid keys in `crates/cairn-core/src/knowledge.rs` (FR-796a–d, FR-824)
