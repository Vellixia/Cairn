...
maps to a verification strategy at a named tier. Written because Feature 002 carries 139
...
| FR-107–FR-111, FR-207–FR-209, FR-229 | Capability model and level | `cairn-integrate::capability` — profiles as data, level and completion-guarantee derivation; the idle reaper never sets it (D22a) | [data-model.md](./data-model.md) §CapabilityProfile, [integration-health.md](./contracts/integration-health.md) |
| FR-112–FR-119, FR-230, FR-231 | Canonical lifecycle | `AgentAdapter::normalize`, `cairn-core` event type, daemon handlers | [lifecycle.md](./contracts/lifecycle.md), D20–D22 |
...
| FR-140–FR-144 | Skill | `skills/cairn/` embedded; `satisfied_by` sharing | D28, D29 |
| FR-145–FR-150, FR-228, FR-232–FR-235 | Ownership | `ResourceState`, `MigrationState`, manager boundary | [data-model.md](./data-model.md), [cc-switch.md](./contracts/cc-switch.md) |
...
| FR-178–FR-181, FR-236, FR-237 | Disconnect | `cairn disconnect`; manager-owned resources reported, never removed | [cc-switch.md](./contracts/cc-switch.md) |
...
Coverage: **139 of 139**. FR-189–FR-192 are satisfied by an absence — the design adds no
...
| SC-110 every claimed event proved; every unclaimed one silent | T3 | `tests/integrations/*` — positive and negative halves |
...
Coverage: **35 of 35**, with 31 in required CI and 4 (SC-101, and the live halves of SC-108,
...
| Agent config files | whole file, to plan and verify | only Cairn's own entries and their hashes | file paths, never content | no |
