...
Either add `web/src/app/(app)/trust/anchor/page.tsx` that re-exports `DriftAnchorCard`, or update `web/test/flows.md` to target `/#anchor` (the widget's DOM position).